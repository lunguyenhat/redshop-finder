...
class RedshopControllerProduct_Detail extends RedshopController
{
	...
	public function publish()
	{
		...
		$result = $dispatcher->trigger('onContentChangeState', array('com_redshop.product_detail', $cid, 1));
	...
	public function unpublish()
	{
		...
		// Trigger the onContentChangeState event.
		$result = $dispatcher->trigger('onContentChangeState', array('com_redshop.product_detail', $cid, 0));
